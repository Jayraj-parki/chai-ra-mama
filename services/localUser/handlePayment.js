                ...
                handler: async (response) => {
                    ...
                    try {
                        ...
                        if (!verification) {
                            ...
                            setAlert({ modalActive: true, workStatus: "processing", message: "Please wait..." });
                            await updateClientProduct({ userId: email, _id: email, update: "payment" });
                            await saveClientCheckoutData({ userId: email, storeId: selectedStore });
