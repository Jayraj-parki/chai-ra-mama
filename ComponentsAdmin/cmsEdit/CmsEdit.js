...
const CmsEdit = ({ editData, setEditData }) => {
  ...
  const UpdateData = async () => {
    ...
    await updateCmsData({ cmsHeading, cmsContent, cmsImage, _id, clearForm, helper, setEditData, setAlert })
                  ...
                  <div className='row col-12 mx-auto mt-2'>
                    <div>
                      ...
                      <div className="mb-4">
                        ...
                        <input  autoComplete="off"  type="file" onChange={(e) => setCmsImage(e.target.files[0])} ref={imageRef} accept="image/*" className="form-control shadow-none" id="editImage" />
                      </div>
                      <div className={" mb-4 "}>
