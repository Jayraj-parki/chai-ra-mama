  ...
  return (
    ...
    <div className={style.menu + ' container-fluid my-4  shadow rounded-4 p-4'}>
      <div className={style.header + ' row col-12 mx-auto d-flex justify-content-start '}>
        ...
        <Link href="./menu/add" className='col-auto  ms-auto btn btn-success text-decoration-none m-2 text-capitalize'> Add Menu</Link>
        ...
        <table className="col-12 table table-bordered table-hover  text-center text-capitalize ">
          ...
          <tbody>
            <tr className=''>
              ...
              <td className='text-center align-middle'>
                <Link href="./menu/edit/12345" className='btn btn-primary text-decoration-none mx-2  text-capitalize'>Edit</Link>
