                  ...
                  return (
                    <tr key={val?._id + "" + index + "" + Math?.random(10000)} className=''>
                      ...
                      <td className='text-center align-middle'>
                        <button onClick={() => approveRequest(val?._id)} className='btn btn-primary text-decoration-none mx-2  text-capitalize'>Approve</button>
                        <button onClick={() => rejectRequest(val?._id)} className='btn btn-danger text-decoration-none m-2'>Reject</button>
                      </td>
                    </tr>)
                })
              }
