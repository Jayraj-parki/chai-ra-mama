...
const GalleryAdd = ({ addData, setAddData }) => {
  ...
  const AddData = async () => {
    ...
    await AddGalleryData({ galleryImage, galleryTitle, helper, setAddData, clearForm,setAlert })
  }
                  ...
                  <div className='row col-12 mx-auto mt-2'>
                    <div>
                      <div className="mb-4">
                        ...
                        <select class="form-select shadow-none" value={products.includes(galleryTitle) ? galleryTitle : ""} onChange={(e) => setGalleryTitle(e.target?.value)}>
                      ...
                      <div className="mb-4">
                        ...
                        <input  autoComplete="off"  value={galleryTitle} onChange={(e) => setGalleryTitle(e.target?.value)} type="text" className="form-control shadow-none" placeholder='Enter new title here' />
                      </div>
                      <div className="mb-4">
                        ...
                        <input  autoComplete="off"  onChange={(e) => setGalleryImage(e.target?.files[0])} ref={imageRef} type="file" accept="image/*" className="form-control shadow-none" />
                      </div>
