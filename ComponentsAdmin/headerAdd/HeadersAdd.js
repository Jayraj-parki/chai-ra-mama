                  ...
                  <div className='row col-12 mx-auto mt-2'>
                    <div className=''>
                      <div className={" mb-4 "}>
                        ...
                        <input  autoComplete="off"  value={headerName} onChange={(e) => setHeaderName(e.target?.value)} name="headerName" type="text" className="form-control shadow-none" placeholder='write something here' />
                      ...
                      <div className="mb-4 ">
                        ...
                        <input  autoComplete="off"  type="file" accept="image/*" className="form-control shadow-none" id="editImage" />
                      </div>
