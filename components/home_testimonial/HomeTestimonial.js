    ...
    return (
        <div className={style.testimonial + ' container-fluid m-0 my-0 p-0 py-5'}>
            ...
            <div className='row col-10 mx-auto d-flex justify-content-between'>
                <div className='col-12 m-1 d-flex justify-content-center flex-column '>
                    <div className='row col-12 mx-auto p-0 d-flex justify-content-center'>
                        <Image className='py-2 ' src={"/assets/images/1.png"} width={50} height={50} objectFit='cover' alt='gallery image' />
                    </div>
                    <div className="row col-4 mx-auto p-0 d-flex justify-content-center">
                ...
                <div className='col-4 m-1 d-flex justify-content-center flex-column '>
                    <div className='row col-12 mx-auto p-0 d-flex justify-content-center'>
                        <Image className='py-2 ' src={"/assets/images/1.png"} width={50} height={50} objectFit='cover' alt='gallery image' />
                    </div>
                    <div className="row col-12 mx-auto p-0 d-flex justify-content-center">
