...
const HomeGetInTouch = () => {
    return (
        <div className={style.getInTouch + ' container-fluid m-0 my-5 p-0 py-5'}>
            ...
            <div className={style.container+' row col-10 flex-wrap mx-auto d-flex justify-content-between align-content-center'}>
                <div className='row col-5 my-auto my-0 mx-auto p-0 d-flex justify-content-center'>
                    <Image className='p-0 m-0' src={"/assets/images/g1.png"} width={400} height={300} objectFit='cover' alt='gallery image' />
                </div>
                <div className="row col-6  py-3 mx-auto p-0 d-flex justify-content-center">
