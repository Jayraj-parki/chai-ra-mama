...
const FAQ = () => {
    ...
    return (
        <div className={style.faq + " container-fluid  pb-5"}>
            <div className='row col-12 py-5 '>
                ...
                <div className={style.about_heading + " row col-12 d-flex  mb-3 d-flex mx-auto   d-flex justify-content-center  "}>
                    <h1 className=" col-6  fw-bold text-justify text-center text-uppercase">Frequently asked question</h1>
                </div>
                <div className={style.faqCard + " row col-12 d-flex  mb-3 d-flex mx-auto   d-flex justify-content-center  "}>
