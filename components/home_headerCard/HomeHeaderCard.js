                        ...
                        return (
                            <div key={val._id} className={style.homeCard + " card col-sm-8 my-2 col-md-4 col-xl-3 d-flex justify-content-center align-items-center m-xl-2 border-0 shadow-lg p-2"}>
                                <div className={style.icon + " col-auto px-2 px-sm-0 px-xl-2 mx-auto my-3  "}>
                                    <Image className={style.bgImg + " d-block w-100 m-0 p-0  "} width={100} height={100} objectFit="cover" src={val?.cmsImage || "/assets/images/1.png"} alt="..." />
                                </div>
                                <div className="card-body">
                                    <h5 className={style.cardTitle + " card-title text-center"}>{val?.cmsHeading}</h5>
